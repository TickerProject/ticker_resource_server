...
import org.ticker.auth.config.KeycloakServerProperties.AdminUser;
public class KeycloakApplication extends org.keycloak.services.resources.KeycloakApplication {
	private static final Logger LOG = LoggerFactory.getLogger(KeycloakApplication.class);
	static KeycloakServerProperties keycloakServerProperties;
	protected void loadConfig() {
        JsonConfigProviderFactory factory = new TickerJsonConfigProviderFactory();
